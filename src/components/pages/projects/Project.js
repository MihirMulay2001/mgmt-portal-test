		...
		<div className='card shadow mb-5'>
			...
			<div className='row button text-center'>
				...
				<Modal show={showTask} onHide={handleCloseTask}>
					...
					<Modal.Body>
						<Link to={`/dashboard/projects/addtask/${project._id}`} className='btn'>
							Add Tasks
						</Link>
						<Link className='btn' to={`/dashboard/projects/getalltasks/${project._id}`}>
							View All tasks
						</Link>
				...
				<Modal show={show} onHide={handleClose}>
					...
					<Modal.Body>
						<Link to='/dashboard/projects/addproject' className='btn'>
							Add Project
						</Link>
						<Link className='btn' to={`/dashboard/projects/updateproject/${project._id}`}>
							Update
						</Link>
						<Link to={`/dashboard/projects/${project._id}`} className='btn'>
							View Details
						</Link>
					</Modal.Body>
					<Modal.Footer>
